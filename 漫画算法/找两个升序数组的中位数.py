...
# my_array_A=list([3,5,6,7,8,9,20,21])
# my_array_B=list([1,10,17])
# my_array_A = list([3,5,6,7,8,15,20])
# my_array_B = list([1,10,12,18,21,24,25,27])
my_array_A = list([3,5,7,8,9])
my_array_B = list([1,2,6,7,15])
